...
return array(
  ...
  'field_share_medium' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    'name' => 'field_share_medium',
    'type' => 'String',
    'quick_form_type' => 'Element',
    'html_type' => 'text',
    'default' => 'custom_35',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Custom field for share medium',
    'description' => "Custom field for share medium",
    'help_text' => "Custom field for share medium",
  ),
  'field_share_tracking_code' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    'name' => 'field_share_tracking_code',
    'type' => 'String',
    'quick_form_type' => 'Element',
    'html_type' => 'text',
    'default' => 'custom_36',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Custom field for share tracking code',
    'description' => "Custom field for share tracking code",
    'help_text' => "Custom field for share tracking code",
  ),
  'from' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
