...
return array(
  ...
  'field_url_campaign' => array(
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'URL of campaign on speakout',
    'description' => "URL of campaign on speakout",
    'help_text' => "URL of campaign on speakout",
  ),
  ...
  'field_twitter_share_text' => array(
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Text used in twitter sharing',
    'description' => "Text used in twitter sharing",
    'help_text' => "Text used in twitter sharing",
  ),
  'field_subject_new' => array(
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Subject for the emails to the contacts that aren\'t already members and need to confirm their signature',
    'description' => 'Subject for the emails to the contacts that aren\'t already members and need to confirm their signature',
    'help_text' => 'Subject for the emails to the contacts that aren\'t already members and need to confirm their signature',
  ),
  'field_subject_current' => array(
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Subject for the emails to the contacts that are already members and don\'t need to confirm their signature',
  ...
  'message_new' => array(
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Body for the emails to the contacts that aren\'t already members and need to confirm their signature',
  ...
  'message_current' => array(
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Body for the emails to the contacts that are already members and don\'t need to confirm their signature',
    'description' => 'Body for the emails to the contacts that are already members and don\'t need to confirm their signature',
    'help_text' => 'Body for the emails to the contacts that are already members and don\'t need to confirm their signature',
  ),
  'from' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
