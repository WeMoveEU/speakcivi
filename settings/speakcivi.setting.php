...
return array(
  ...
  'field_welcome_new' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    'name' => 'field_welcome_new',
    'type' => 'String',
    'quick_form_type' => 'Element',
    'html_type' => 'text',
    'default' => 'column_12',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Welcome text for new users in confirmation mail',
    'description' => "Welcome text for new users in confirmation mail",
    'help_text' => "Welcome text for new users in confirmation mail",
  ),
  'field_welcome_old' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    'name' => 'field_welcome_old',
    'type' => 'String',
    'quick_form_type' => 'Element',
    'html_type' => 'text',
    'default' => 'column_13',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Welcome text for old users in confirmation mail',
    'description' => "Welcome text for old users in confirmation mail",
    'help_text' => "Welcome text for old users in confirmation mail",
  ),
  'field_goodbye' => array(
    'group_name' => 'Speakcivi API Preferences',
    'group' => 'speakcivi',
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => 'Goodbye text in confirmation mail',
    'description' => "Goodbye text in confirmation mail",
    'help_text' => "Goodbye text in confirmation mail",
  ),
