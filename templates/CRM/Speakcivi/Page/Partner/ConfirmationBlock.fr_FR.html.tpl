...
<p style="font-size:14px;font-family: arial,helvetica,sans-serif;">En confirmant votre inscription, vous acceptez de recevoir occasionnellement des emails de campagne de WeMove Europe et de l'initiateur de la pétition, {$partner_name}. Pas d’inquiétude ! Nous nous efforçons de vous envoyer des informations qui vous intéressent, et vous pouvez vous désinscrire à tout moment. Nous prenons le respect de votre vie privée très au sérieux et ne transmettrons jamais vos données personnelles à d'autres tiers sans votre accord explicite. Pour en savoir plus sur notre politique de confidentialité : <a href="https://www.wemove.eu/fr/privacy-policy">https://www.wemove.eu/fr/privacy-policy</a> et sur la politique de confidentialité de l'initiateur de la pétition, {$partner_name}, <a href="{$partner_privacy_url}">ici</a>.</p>
