...
<p style="font-size:14px;font-family: arial,helvetica,sans-serif;">Twoje potwierdzenie oznacza, że zgadzasz się otrzymywać wiadomości e-mail o kampaniach WeMove.EU, które od czasu do czasu wysyłamy oraz o kampaniach {$partner_name}. Nie martw się: dokładamy starań, aby te wiadomości były dla Ciebie interesujące. W każdej chwili możesz się wypisać. Szanujemy Twoją prywatność i nigdy nie udostępnimy informacji o Tobie innym stronom trzecim bez Twojego zezwolenia. Więcej informacji znajdziesz w naszej polityce prywatności: <a href="https://www.wemove.eu/pl/privacy-policy">https://www.wemove.eu/pl/privacy-policy</a> oraz w polityce prywatności {$partner_name} – inicjatora petycji, <a href="{$partner_privacy_url}">tutaj</a>.</p>
