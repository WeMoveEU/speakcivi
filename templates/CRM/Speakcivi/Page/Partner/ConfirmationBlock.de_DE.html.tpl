...
<p style="font-size:16px;font-family: arial,helvetica,sans-serif;">Wenn Sie sich für weitere Informationen entscheiden, erklären Sie sich damit einverstanden, von WeMove.EU und dem Initiator der Kampagne {$partner_name} weitere Kampagnen-E-Mails zu erhalten. Seien Sie versichert: Wir tun unser Bestes, damit die Neuigkeiten interessant für Sie sind. Sie können sich jederzeit wieder abmelden.</p>

<p style="font-size:16px;font-family: arial,helvetica,sans-serif;">Wir nehmen den Schutz Ihrer Daten sehr ernst und werden Ihre Daten ohne Ihre ausdrückliche Zustimmung nicht an andere Dritte weitergeben. Mehr dazu erfahren Sie in <a href="https://www.wemove.eu/de/privacy-policy">unserer Datenschutzerklärung</a>,  und der Datenschutzerklärung von {$partner_name}, <a href="{$partner_privacy_url}">hier</a>.</p>
